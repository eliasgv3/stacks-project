...
See Categories, Localization in categories, \ref{section-localization},
for the definition of $S^{-1}\mathcal{C}$.
...
For the uniqueness, suppose $Q$ is an additive functor of
preadditive categories. Let $X, Y$ be objects of $\mathcal{C}$
and
$\alpha, \beta : X \to Y$ be morphisms in $S^{-1}\mathcal{C}$. According to
...
Then
$s^{-1}f+s^{-1}g
=Q(s)^{-1}\circ Q(f)+Q(s)^{-1}\circ Q(g)=Q(s)^{-1}\circ(Q(f)+Q(g))
=Q(s)^{-1}\circ Q(f+g)
=s^{-1}(f+g)$.
Hence, the preadditive structure in $S^{-1}\mathcal{C}$
is determined by that of $\mathcal{C}$.

\medskip\noindent
We see existence. Again, if
$\alpha, \beta : X \to Y$ are morphisms in $S^{-1}\mathcal{C}$, we represent them by pairs $s^{-1}f, s^{-1}g$ with common denominator
