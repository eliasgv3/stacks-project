...
\begin{lemma}
	...
	\begin{enumerate}
		...
		(Topology, Definition \ref{topology-definition-quasi-separated-space}),
...
\begin{proof}
	...
	Topology, Lemma \ref{topology-lemma-quasi-separated-basis}.
...
\begin{enumerate}
	...
	(see Topology, Definition \ref{topology-definition-quasi-separated-space}).
\end{enumerate}
\end{lemma}
